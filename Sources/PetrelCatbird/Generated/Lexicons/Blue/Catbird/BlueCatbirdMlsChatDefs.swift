...
public enum BlueCatbirdMlsChatDefs {
    ...
    public struct MessageView: ATProtocolCodable, ATProtocolValue {
        ...
        public let seq: Int
        public let createdAt: ATProtocolDate
        public let messageType: MessageViewMessageType?

        public init(
            id: String, convoId: String, ciphertext: Bytes, epoch: Int, seq: Int, createdAt: ATProtocolDate, messageType: MessageViewMessageType?
        ) {
            self.id = id
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                messageType = try container.decodeIfPresent(MessageViewMessageType.self, forKey: .messageType)
            } catch {
                // Forward compatibility: a malformed or unknown-shaped optional field
                // must not fail the whole response.
    ...
    public enum MessageViewMessageType: String, Codable, ATProtocolCodable, ATProtocolValue, Sendable {
        case value_app = "app"
        case value_commit = "commit"

        public func isEqual(to other: any ATProtocolValue) -> Bool {
            guard let otherValue = other as? MessageViewMessageType else { return false }
