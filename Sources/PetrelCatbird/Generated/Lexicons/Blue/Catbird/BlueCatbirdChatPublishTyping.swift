...
public enum BlueCatbirdChatPublishTyping {
    ...
    public struct Input: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            signedRequest = try container.decode(BlueCatbirdChatDefs.SignedTyping.self, forKey: .signedRequest)
        }
    ...
    public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            typing = try container.decode(BlueCatbirdChatDefs.TypingEvent.self, forKey: .typing)
        }
