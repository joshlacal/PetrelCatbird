...
public enum BlueCatbirdMlsChatBootstrapResetGroup {
    ...
    public enum Error: String, Swift.Error, ATProtoErrorType, CustomStringConvertible {
        ...
        case bootstrapTargetNotFound = "BootstrapTargetNotFound"
        ...
        case alreadyBootstrapped = "AlreadyBootstrapped"
    ...
    func bootstrapResetGroup(
        ...
        if (200 ... 299).contains(responseCode) {
            ...
            if let atprotoError = ATProtoErrorParser.parse(
                ...
                errorType: BlueCatbirdMlsChatBootstrapResetGroup.Error.self
            ) {
                throw atprotoError
            }
