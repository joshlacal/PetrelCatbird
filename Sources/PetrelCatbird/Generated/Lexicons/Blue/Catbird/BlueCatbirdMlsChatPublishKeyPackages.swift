...
public enum BlueCatbirdMlsChatPublishKeyPackages {
    ...
    public enum Error: String, Swift.Error, ATProtoErrorType, CustomStringConvertible {
        ...
        case missingKeyPackages = "MissingKeyPackages"
        /// localHashes required for 'sync' action
        case missingLocalHashes = "MissingLocalHashes"
        /// deviceId required for 'sync' action
        case missingDeviceId = "MissingDeviceId"
        /// targetDids required for 'requestReplenish' action
        case missingTargetDids = "MissingTargetDids"
    ...
    func publishKeyPackages(
        ...
        if (200 ... 299).contains(responseCode) {
            ...
            if let atprotoError = ATProtoErrorParser.parse(
                ...
                errorType: BlueCatbirdMlsChatPublishKeyPackages.Error.self
            ) {
                throw atprotoError
            }
