...
public struct Audio: ATProtocolCodable, ATProtocolValue {
        ...
        public init(
            codec: AudioCodec, rate: Int, channels: Int
        ) {
            self.codec = codec
            self.rate = rate
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            do {
                self.codec = try container.decode(AudioCodec.self, forKey: .codec)
            } catch {
...
public struct Video: ATProtocolCodable, ATProtocolValue {
        ...
        public init(
            codec: VideoCodec, width: Int, height: Int, framerate: Framerate?, bframes: Bool?
        ) {
            self.codec = codec
            self.width = width
            self.height = height
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            do {
                self.codec = try container.decode(VideoCodec.self, forKey: .codec)
            } catch {
                LogManager.logError("Decoding error for required property 'codec': \(error)")
                throw error
            }
...
public enum AudioCodec: String, Codable, ATProtocolCodable, ATProtocolValue, Sendable {
    case value_opus = "opus"

    public func isEqual(to other: any ATProtocolValue) -> Bool {
        guard let otherValue = other as? AudioCodec else { return false }
...
public enum VideoCodec: String, Codable, ATProtocolCodable, ATProtocolValue, Sendable {
    case value_h264 = "h264"

    public func isEqual(to other: any ATProtocolValue) -> Bool {
        guard let otherValue = other as? VideoCodec else { return false }
        return self == otherValue
    }
