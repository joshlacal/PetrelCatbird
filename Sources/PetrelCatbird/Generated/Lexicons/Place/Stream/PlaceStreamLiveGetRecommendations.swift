...
public struct LivestreamRecommendation: ATProtocolCodable, ATProtocolValue {
            ...
            public let did: DID
            public let source: LivestreamRecommendationSource

        public init(
            did: DID, source: LivestreamRecommendationSource
        ) {
            self.did = did
            self.source = source
        }
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.source = try container.decode(LivestreamRecommendationSource.self, forKey: .source)
            } catch {
...
public enum LivestreamRecommendationSource: String, Codable, ATProtocolCodable, ATProtocolValue, Sendable {
    case value_streamer = "streamer"
    case value_follows = "follows"
    case value_host = "host"

    public func isEqual(to other: any ATProtocolValue) -> Bool {
        guard let otherValue = other as? LivestreamRecommendationSource else { return false }
